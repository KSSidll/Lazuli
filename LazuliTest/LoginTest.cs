...
public class LoginTest
{
	...
	// 	// TODO find out how to check this so that it doesn't just check initial value and then just timeout
	// 	component.WaitForElement(".spinner-border", TimeSpan.FromSeconds(10));
